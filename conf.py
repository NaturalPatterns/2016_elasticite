...
BLOG_AUTHOR = "Laurent Perrinet, INT/CNRS"  # (translatable)
BLOG_TITLE = "Elasticité dynamique"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://elasticite.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://bicv.github.io/"
BLOG_EMAIL = "laurent.perrinet@univ-amu.fr"
BLOG_DESCRIPTION = "Supporting material for the exhibit"  # (translatable)
...
#         ("/categories/", "Tags"),
#         ("/rss.xml", "RSS feed"),
        ('http://invibe.net/LaurentPerrinet/EtienneRey', 'Links'),#, 'icon-user'),
        ('https://laurentperrinet.github.com/elasticite', 'Github'),
    ),
}
...
# LOGO_URL = './galleries/bicv_banner.jpg'
