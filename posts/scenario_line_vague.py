...
class EdgeGrid(el.EdgeGrid):
    def __init__(self, z, x_offset=0, y_offset=0, t_offset=0, N_steps = 256, **kwargs):
    ...
    def update(self):
        ...
        i = np.int(self.t/self.period * self.N_steps)
        #print(self.x_offset)#, self.y_offset, self.t_offset)
        #print(i)
        #print(self.z.shape)
        #self.lames[2, :N_lame] = self.z[self.x_offset:(self.x_offset+N_lame), self.y_offset, self.t_offset+i]
        self.lames[2, :N_lame] = self.z[:N_lame, 0, i]
...
if __name__ == "__main__":
    ...
    e = EdgeGrid(N_lame=25, grid_type='line', mode=mode,
                 verb=True, filename='mat/line_vague.npy', period=20., 
                 z = vague_dense,
